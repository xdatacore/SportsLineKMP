...
@Composable
fun SellerSalesScreen(viewModel: SellerSalesViewModel) {
    ...
    Column(modifier = Modifier.fillMaxSize().padding(8.dp)) {
        ...
        Row(
            ...
            Text("Seleccionar Cliente:", modifier = Modifier.padding(end = 8.dp))
            Box(modifier = Modifier.fillMaxWidth()) {
                ExposedDropdownMenuBox(
                    ...
                    TextField(
                        value = selectedCliente?.let { "${it.nombre} ${it.apellido}" } ?: "",
                        onValueChange = {},
                        label = { Text("Cliente") },
                        readOnly = true,
                        trailingIcon = {
        ...
        Button(
            onClick = { viewModel.completeSale(selectedCliente, selectedProductos) },
            modifier = Modifier.fillMaxWidth().padding(8.dp)
        ) {
