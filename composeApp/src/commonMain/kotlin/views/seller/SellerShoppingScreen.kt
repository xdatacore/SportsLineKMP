...
@Composable
fun SellerShoppingScreen(viewModel: SellerShoppingViewModel) {
    ...
    var selectedClienteProveedor by remember { mutableStateOf<ClienteProveedor?>(null) }
    ...
    Column(modifier = Modifier.fillMaxSize().padding(8.dp)) {
        ...
        Row(
            ...
            Text("Seleccionar Proveedor:", modifier = Modifier.padding(end = 8.dp))
            Box(modifier = Modifier.fillMaxWidth()) {
                ExposedDropdownMenuBox(
                    ...
                    TextField(
                        value = selectedClienteProveedor?.let { "${it.nombre} ${it.apellido}" }
                            ?: "",
                        onValueChange = {},
                    ...
                    ExposedDropdownMenu(
                        ...
                        clientesProveedorState.forEach { cliente ->
                            DropdownMenuItem(
                                onClick = {
                                    selectedClienteProveedor = cliente
        ...
        Button(
            onClick = { viewModel.completeShopping(selectedClienteProveedor, selectedProductos) },
            modifier = Modifier.fillMaxWidth().padding(8.dp)
        ) {
    ...
    Card(
        ...
        Column(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Text(
                    text = "₡${(producto.precioVenta - (producto.precioVenta * 0.40))}",
